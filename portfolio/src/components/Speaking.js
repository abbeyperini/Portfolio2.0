      ...
      <SingleWrapper home={home}>
        ...
        <section aria-label="Speaking" className="container_speaking" name="Speaking">
            ...
            <div className="talks secondary-container">
              ...
              <ul className="talk-list">
                <li><p className="event_title">React Summit Amsterdam 2026</p><a href="https://gitnation.com/contents/what-the-first-rule-of-aria-really-means" rel="noreferrer" className="talk_link">What the First Rule of ARIA Really Means</a></li>
                <li><p className="event_title">React Summit US 2025</p><a href="https://gitnation.com/contents/slots-slots-slots-everybody" rel="noreferrer" className="talk_link">Slots, Slots, Slots, Everybody!</a></li>
              ...
              <ul className="talk-list">
                <li><a href="https://overcommitted.dev/accessibility-fiber-arts-and-adhd-with-abbey-perini/" rel="noreferrer" className="talk_link">Overcommitted Podcast</a></li>
                <li><a href="https://www.youtube.com/watch?v=cZJ19XzS3ng" rel="noreferrer" className="talk_link">Frontend Queens' Global Accessibility Awareness Day: Building an Inclusive Web</a></li>
