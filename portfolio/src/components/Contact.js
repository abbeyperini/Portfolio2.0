        ...
        <section aria-label="Contact links and form" className="flex-container container_contact">
            ...
            <div className="contact">
                ...
                <ul className="contact_list">
                  ...
                  <li><a className="link-new-tab" href="https://dev.to/abbeyperini" target="_blank" rel="noreferrer" aria-label="link to Abbey's Profile on DEV">DEV<ExternalLink className="external-link" id="DEVExternalLink" focusable="false"/></a><DEVLogo className="contact-logo" focusable="false" /></li>
                  <li><a className="link-new-tab" href="https://abbeyperini.hashnode.dev/" target="_blank" rel="noreferrer" aria-label="link to Abbey's Profile on Hashnode">Hashnode<ExternalLink className="external-link" id="HashnodeExternalLink" focusable="false"/></a><img src={HashnodeLogo} alt="" className="contact-logo"/></li>
                </ul>
