...
function Blog() {
    return (
        <section aria-label="Blog" className="container_blog" name="Blog">
            ...
            When I make a bit more progress, all my blogs will be in my <a href="https://github.com/abbeyperini/digital-garden">digital garden</a><ExternalLink className="external-link" id="AuditBlogSeriesExternalLink" focusable="false"/>.</p>
        </section>
    )
}
