...
function Content({home}) {
    return (
      <SingleWrapper home={home}>
        ...
        <section aria-label="Writing" className="container_content" name="Content">
            ...
            <div className="secondary-container content-content">
              ...
              <p>You can find my writing on <a href="https://dev.to/abbeyperini" rel="noreferrer">DEV</a> and in my <a href="https://www.abbeyperini.com" rel="noreferrer">digital garden</a> (a work in progress).</p>
