    ...
    return (
        <article className="blog">
            ...
            <p>Semantic HTML has a lot of <a href="https://developer.mozilla.org/en-US/docs/Learn/Accessibility/HTML">built in features</a> to take some of the accessibility work off of
                the developer. For instance, a <code>&lt;button&gt;</code> is automatically keyboard accessible! Some of the HTML that should always be included in a page is pretty straightforward
                ...
                <a href="https://www.w3.org/TR/wai-aria-practices/examples/landmarks/HTML5.html">ARIA Landmarks</a> (e.g. a <code>&lt;div&gt;</code> or a <code>&lt;span&gt;</code> should be your last resort).</p>
            ...
            <p>Finally, <a href="https://web.dev/accessibility-auditing-react/">audit your React app</a> with <a href="https://github.com/dequelabs/react-axe"><code>react-axe</code></a> and 
                <a href="https://github.com/jsx-eslint/eslint-plugin-jsx-a11y"> <code>eslint-plugin-jsx-a11y</code></a>.</p>
