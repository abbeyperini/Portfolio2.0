...
function Blog8() {
     return (
          <article className="blog">
               ...
               <h1 className="blog_title">Knitting as Programming</h1>
               <h2 className="blog_title-secondary">or how I learned programmers owe it all to fiber</h2>
               <h3 className="blog_published-heading">Originally published on dev.to on February 10, 2021</h3>
               <h3 className="caption">Cover photo knit by Abbey Perini. The pattern is Embrace Octopus Sweater by Maia E. Sirnes. The yarn is Malabrigo Rios in Whale Road and Natural.</h3>
               ...
               <h3 className="blog_title-tertiary">The Beginning</h3>
               ...
               <p>The direction the current was forced through the wires induced field forces to circulate in a clockwise or counterclockwise direction. One 
                    ...
                    the time.</p>
               <h3 className="blog_title-tertiary">Now</h3>
               ...
               <h3 className="blog_title-tertiary">A Knitting Primer</h3>
               ...
               <h3 className="blog_title-tertiary">Patterns as Programming</h3>
               <ul>
               ...
               <h3 className="blog_title-tertiary">Patterns as Regular Expressions</h3>
               <p>Say we want to make a square of ribbing. <code>kp</code> is the <a href="https://regexone.com/">regular expression</a> for one knit stitch followed
                    ...
                    <code>{`((kp){x}\n(pk){x}\n){y}`}</code>.</p>
               <h3 className="blog_title-tertiary">Patterns as Tools for Teaching Programming</h3>
               <blockquote>"Knitting patterns have evolved from vague, chatty discourse written for experts to precise, line-by-line procedures that are akin to
                    programs."</blockquote>
               <p className="caption">-- "<a href="https://www.researchgate.net/publication/241623956_Following_a_thread_Knitting_patterns_and_program_tracing">Following a thread:
               ...
               <h3 className="blog_title-tertiary">Additional Fun</h3>
               <ul>
               ...
               <h3 className="blog_title-tertiary">Additional Sources</h3>
               <ul>
