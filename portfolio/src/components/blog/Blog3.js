...
function Blog3() {
    return (
        <article className="blog">
            <img src={Blog3Cover} alt="a tan login button with offset border on a blue background" className="blog_image"></img>
            <h1 className="blog_title">CSS Animated Button with Offset Border</h1>
            <h2 className="blog_published-heading">Originally published on Medium on December 16, 2020</h2>
            ...
            <img src={Blog3Button} className="blog_image" alt="a tan add button with offset border on a teal and blue background, when clicked the main button moves to meet its offset border, the text color changes and a blue focus outline appears"></img>
            <h3 className="blog_title-tertiary">To div or not to div</h3>
            <p>I researched a few ways to make the offset border without wrapping it in a container, but ultimately, I wanted an animation that looked like the button was moving into
                ...
                button.</p>
            <h3 className="blog_title-tertiary">The div solution</h3>
