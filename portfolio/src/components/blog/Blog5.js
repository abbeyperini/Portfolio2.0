...
function Blog5() {
     return (
          <article className="blog">
               ...
               {/* <!-- "Here is my desired state. Make it so!" - Captain Picard --> */}
               ...
               {/* <!-- Many Spongebobs sitting at office desks as a metaphor for the mind --> */}
               ...
               {/* <!-- An office worker hits a button and a large coffee machine squirts coffee directly in her mouth. She then types frantically. --> */}
               ...
               {/* <!-- A French Press says to a coffee machine "You automatic coffee machines think you're so great, huh? But can you do this?" The coffee machine watches in confusion as the french press
                    rapidly moves its plunger. -->
               <!-- Now two french presses are rapidly moving their plungers, and the automatic coffee machine looks horrified. --> */}
               ...
               {/* <!-- A seagull and crab discuss the crab's mysterious journey in a small row boat, ending with "any details will remain a mystery." --> */}
               ...
               {/* <!-- A dog mom stands in front of her puppies. The caption reads "I made dis. And dis. And dis. And dis. And dis. And dis." --> */}
               ...
               {/* <!-- Fred from Scooby Doo unmasks a ghost villain to reveal... also Fred --> */}
               ...
               {/* <!-- "Me: *explains polymorphism* Friend: So the subclass the same as the superclass? Me:" a picture of a claymation pirate saying "Well yes, but actually no" --> */}
               <h3>Conclusion</h3>
