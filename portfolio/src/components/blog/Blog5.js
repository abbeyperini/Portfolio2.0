...
function Blog5() {
     return (
          <article className="blog">
               <h1 className="blog_title">Object Oriented Programming in Memes</h1>
               ...
               <p>First, I’ll cover the basics: objects, classes, instance, and methods. Then, I’ll briefly explain the four main pillars of OOP design: Encapsulation, Abstraction, Inheritance,
                    and Polymorphism.</p>
               <h3 className="blog_title-tertiary">Objects</h3>
               ...
               <h3 className="blog_title-tertiary">Classes</h3>
               ...
               <h3 className="blog_title-tertiary">Instance</h3>
               ...
               <h3 className="blog_title-tertiary">Methods</h3>
               ...
               <hr></hr>
               <h3 className="blog_title-tertiary">Encapsulation</h3>
               ...
               <h3 className="blog_title-tertiary">Abstraction</h3>
               ...
               <h3 className="blog_title-tertiary">Inheritance</h3>
               ...
               <h3 className="blog_title-tertiary">Polymorphism</h3>
