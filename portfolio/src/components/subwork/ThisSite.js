...
function ThisSite() {
    return (
        <div id="this" className="subWork">
            ...
            a lot about keyframes! I spent a lot of time on the light/dark mode - bulding the toggle, flipping it, adjusting its size, and making sure it shows the correct side no matter which theme is
