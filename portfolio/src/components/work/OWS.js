    ...
    return (
        <div id="OWS" className="work">
            ...
            <span className="work_links">
                <a className="link-new-tab" href="https://github.com/abbeyperini/OldWallSite" target="_blank" rel="noreferrer"><Github id="OWSGithub" aria-label="open Old Wall Site Github repository in a new tab" className="work_icon" /></a>
            </span>
        </div>
    )
}
