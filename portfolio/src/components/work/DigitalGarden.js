    ...
    return (
        <div id="digitalGarden" className="work">
            ...
            <span className="work_links">
                <a className="link-new-tab" href="https://github.com/abbeyperini/digital-garden" target="_blank" rel="noreferrer"><Github id="DigitalGardenGithub" role="img" aria-label="open Digital Garden Github repository in a new tab" className="work_icon"/></a>
                <a className="link-new-tab" href="https://abbeyperini.com" target="_blank" rel="noreferrer"><Chrome id="DigitalGardenChrome" role="img" aria-label="open Digital Garden website in a new tab" className="work_icon"/></a>
            </span>
        </div>
    )
}
