        ...
        <div id="this" className="work_this">
            ...
            <p className="work_text">
              Back in early 2021, I was job hunting and not happy with my professional portfolio being a template attached to a static personal site.
               ...
               {" "}<a href="https://dev.to/abbeyperini/a-walkthrough-of-updating-my-portfolio-site-with-netlify-functions-and-the-dev-to-api-dd2" target="_blank" rel="noreferrer" aria-label="link to Abbey's Netlify serverless functions blog post on DEV">added Netlify serverless functions</a><ExternalLink className="external-link" id="WalkthroughBlogExternalLink" focusable="false" aria-hidden="true"/>
               {" "}<a href="https://dev.to/abbeyperini/adding-shiba-inu-loading-and-error-svgs-to-my-react-site-lnj" target="_blank" rel="noreferrer" aria-label="link to Abbey's SVG Article on DEV"> added Shiba Inu loading and error SVGs,</a><ExternalLink className="external-link" id="ShibaInuExternalLink" focusable="false" aria-hidden="true"/>
               {" and "}
               <a href="https://dev.to/abbeyperini/dark-mode-toggle-and-prefers-color-scheme-4f3m" target="_blank" rel="noreferrer" aria-label="link to Abbey's Prefers Color Scheme Article on DEV">updated the dark mode toggle.</a><ExternalLink className="external-link" id="PrefersColorSchemeLink" focusable="false" aria-hidden="true"/>
               
            </p>
            <span className="work_links">
                <a className="link-new-tab" href="https://github.com/abbeyperini/Portfolio2.0" target="_blank" rel="noreferrer"><Github id="ThisSiteGithub" role="img" aria-label="open Github repository for this site in a new tab" className="work_icon"/></a>
            </span>
        </div>
    )
}
