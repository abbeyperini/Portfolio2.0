    ...
    return (
        <div id="this" className="work_this">
            ...
            <span className="work_links">
                <a className="link-new-tab" href="https://github.com/abbeyperini/Portfolio2.0" target="_blank" rel="noreferrer"><Github id="ThisSiteGithub" aria-label="open Github repository for this site in a new tab" className="work_icon"/></a>
            </span>
        </div>
    )
}
